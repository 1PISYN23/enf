...
from django.contrib.auth.models import AbstractUser, BaseUserManager  # сразу вопрос что делают для и для чего используются? 
from django.utils.html import strip_tags  # также что делает и для чего? 
